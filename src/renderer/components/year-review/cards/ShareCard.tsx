...
export const ShareCard: React.FC<ReviewCardProps> = ({ data }) => {
  ...
  const handleCopyStats = () => {
    const text = `🎄 My 2025 Claude Code Year in Review generated by Claude Owl 🎄
...
#ClaudeOwl #ClaudeCode #YearInReview #AI #Coding`;
  ...
  const handleTweet = async () => {
    const text = encodeURIComponent(
      `🎄 My 2025 Claude Code Year in Review generated by Claude Owl 🎄
  ...
  return (
    <div className="text-center text-white">
      ...
      <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-xl p-6 max-w-sm mx-auto border border-white/10 shadow-xl mb-6">
        <div className="text-center">
          ...
          <div className="text-xs text-white/40">
            ...
            Claude Owl • github.com/antonbelev/claude-owl
          </div>
        </div>
      </div>
      ...
      <p className="mt-6 text-white/50 text-sm">
        Thanks for being part of the Claude Owl community! 🦉
      </p>
    </div>
  );
};
